...
parameterizedTest(
  ...
  [
    ...
    [ "0728"                       , s([28])     , all             , all              , p(1) , s([7])  , 0         , 0             , undefined            ],
    [ "1001"                       , s([1])      , all             , all              , p(1) , s([10]) , 0         , 0             , undefined            ],
    [ "0101"                       , s([1])      , all             , all              , p(1) , s([1])  , 0         , 0             , undefined            ],
    [ "1231"                       , s([31])     , all             , all              , p(1) , s([12]) , 0         , 0             , undefined            ],
